            ...
            <div class="entity-list">
                <?php $__currentLoopData = $shelves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $shelf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($index !== 0): ?>
                        <hr class="my-m">
                    <?php endif; ?>
                    <?php echo $__themeViews->handleViewInclude('shelves.parts.list-item', ['shelf' => $shelf], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
        ...
        <?php else: ?>
            <div class="grid third">
                <?php $__currentLoopData = $shelves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $shelf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__themeViews->handleViewInclude('entities.grid-item', ['entity' => $shelf], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        <?php endif; ?>
        <div>
