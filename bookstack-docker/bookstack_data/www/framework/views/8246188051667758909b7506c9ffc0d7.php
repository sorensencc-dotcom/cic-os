    ...
    <div class="container mt-l">
        ...
        <div class="card mb-xl px-l pb-l pt-l">
            <div class="grid half v-center">
                <div>
                    <?php echo $__themeViews->handleViewInclude('errors.parts.not-found-text', [
            ...
            <div class="grid third gap-xxl">
                <div>
                    <div class="card mb-xl">
                        ...
                        <div class="px-m">
                            <?php echo $__themeViews->handleViewInclude('entities.list', ['entities' => $popular->run(10, 0, ['page']), 'style' => 'compact'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="card mb-xl">
                        ...
                        <div class="px-m">
                            <?php echo $__themeViews->handleViewInclude('entities.list', ['entities' => $popular->run(10, 0, ['book']), 'style' => 'compact'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="card mb-xl">
                        ...
                        <div class="px-m">
                            <?php echo $__themeViews->handleViewInclude('entities.list', ['entities' => $popular->run(10, 0, ['chapter']), 'style' => 'compact'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                        </div>
                    </div>
                </div>
            </div>
