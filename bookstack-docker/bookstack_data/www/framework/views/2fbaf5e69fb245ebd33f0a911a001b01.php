<form action="<?php echo e(url('/login')); ?>" method="POST" id="login-form" class="mt-l">
    ...
    <div class="stretch-inputs">
        <div class="form-group">
            ...
            <?php echo $__themeViews->handleViewInclude('form.text', ['name' => 'email', 'autofocus' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
        </div>

        <div class="form-group">
            <label for="password"><?php echo e(trans('auth.password')); ?></label>
            <?php echo $__themeViews->handleViewInclude('form.password', ['name' => 'password'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
