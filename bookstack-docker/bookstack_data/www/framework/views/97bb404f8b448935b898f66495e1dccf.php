        ...
        <div class="list-sort">
            <div component="dropdown" class="list-sort-type dropdown-container">
                <button refs="dropdown@toggle"
                        ...
                        class="list-sort-toggle"><?php echo e($options[$selectedSort]); ?></button>
                <ul refs="dropdown@menu list-sort-control@menu" class="dropdown-menu" role="menu">
                    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li <?php if($key === $selectedSort): ?> class="active" <?php endif; ?>><a href="#" data-sort-value="<?php echo e($key); ?>" role="menuitem" class="text-item"><?php echo e($label); ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
