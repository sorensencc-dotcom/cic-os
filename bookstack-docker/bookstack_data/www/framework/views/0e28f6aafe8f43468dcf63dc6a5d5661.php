<?php $__env->startSection('content'); ?>
    ...
    <div class="container very-small">
        ...
        <div class="card content-wrap auto-height">
            ...
            <?php echo $__themeViews->handleViewInclude('auth.parts.login-message', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>

            <?php echo $__themeViews->handleViewInclude('auth.parts.login-form-' . $authMethod, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
