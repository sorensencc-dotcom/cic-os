<form component="global-search" action="<?php echo e(url('/search')); ?>" method="GET" class="search-box" role="search" tabindex="0">
    ...
    <div refs="global-search@suggestions" class="global-search-suggestions card">
        <div refs="global-search@loading" class="text-center px-m global-search-loading"><?php echo $__themeViews->handleViewInclude('common.loading-icon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?></div>
