...
<div class="form-group entity-selector-container">
    <div component="entity-selector"
        ...
        <div class="text-center loading" refs="entity-selector@loading"><?php echo $__themeViews->handleViewInclude('common.loading-icon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?></div>
