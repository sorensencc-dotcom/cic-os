...
<body
    ...
    <?php echo $__themeViews->handleViewInclude('layouts.parts.base-body-start', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    <?php echo $__themeViews->handleViewInclude('layouts.parts.skip-to-content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    <?php echo $__themeViews->handleViewInclude('layouts.parts.notifications', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    <?php echo $__themeViews->handleViewInclude('layouts.parts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>

    <div id="content" components="<?php echo $__env->yieldContent('content-components'); ?>" class="block">
        <?php echo $__env->yieldContent('content'); ?>
    </div>

    <?php echo $__themeViews->handleViewInclude('layouts.parts.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    ...
    <?php echo $__themeViews->handleViewInclude('layouts.parts.base-body-end', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
</body>
</html>
